...
export const FrenchCalendar = Template.bind({});
FrenchCalendar.args = {
  events: mockEvents,
  weekends: true,
  onEventClick: (event: GenericEvent) =>
  ...
  onSelectDate: (date: Date) => console.log(`Selected date: ${date}`),
  value: new Date(),
  usaCalendar: false, // French format: Monday to Sunday, days in French
};

export const USACalendar = Template.bind({});
USACalendar.args = {
  events: mockEvents,
  weekends: true,
  onEventClick: (event: GenericEvent) =>
  ...
  onSelectDate: (date: Date) => console.log(`Selected date: ${date}`),
  value: new Date(),
  usaCalendar: true, // USA format: Sunday to Saturday, days in English
};
